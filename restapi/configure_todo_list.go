...
import (
	...
	"github.com/crevax/go-swagger-playground/restapi/operations"
	"github.com/crevax/go-swagger-playground/restapi/operations/todos"
)

//go:generate swagger generate server --target .. --name todo-list --spec ../schemas/swagger.yml
